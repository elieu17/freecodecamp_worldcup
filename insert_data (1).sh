...
# clears out all rows from the games and teams tables
echo $($PSQL "TRUNCATE games,teams")

#reads the games CSV and parses the data per the IFS delimiter
...
do
  ...
  then
    ...
    # if value in WINNER_ID variable is null or zero, then run code
      if [[ -z $WINNER_ID ]]
      then
        # insert team
